...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function openProgramWindow(programData) {
        ...
        minimizeButton.textContent = "remove";
        ...
        maximizeButton.textContent = "expand_content";
        ...
        maximizeButton.addEventListener("click", function() {
            ...
            const unmaximizeButton = document.createElement("button");
            unmaximizeButton.textContent = "collapse_content";
            unmaximizeButton.classList.add("unmaximize-button");
            unmaximizeButton.addEventListener("click", function() {
                programWindow.classList.remove("maximized");
        ...
        desktop.appendChild(taskbarIcon);

        programData.window = programWindow;
