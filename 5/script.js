...
function initializeIcons(iconsContainer, desktop, selectionBox) {
    const programs = [
        { name: "My Files", icon: "https://img.icons8.com/color/1500/folder-invoices--v1.png", scriptName: "myFiles.js" },
        { name: "Task Manager", icon: "https://img.icons8.com/color/1500/heart-monitor.png", scriptName: "taskManager.js" },
        { name: "Settings", icon: "https://img.icons8.com/color/1500/gear.png", scriptName: "settings.js" },
        { name: "Calculator", icon: "https://img.icons8.com/color/1500/calculator.png", scriptName: "calculator.js" },
        { name: "Notes", icon: "https://img.icons8.com/color/1500/notepad.png", scriptName: "notes.js" },
        { name: "Weather", icon: "https://img.icons8.com/color/1500/partly-cloudy-day--v1.png", scriptName: "weather.js" },
    ];
